...
var ProductType = document.getElementById('minusBtn').getAttribute('ProductGroup')
...
function buyNow(elm) {
  ...
  if (ProductType == "SolidWeight" || ProductType == "LiquidWeight") {
